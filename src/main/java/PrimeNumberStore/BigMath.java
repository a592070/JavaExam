...
public class BigMath {
     ...
     *
     * @param val Argument
     * @return Natural logarithm, as in {@link Math#log(double)}<br>
    ...
    /**
     * Same as {@link Math#pow(double,double)} but returns a {@link BigDecimal} (precision ~ 16).
     * <p>
